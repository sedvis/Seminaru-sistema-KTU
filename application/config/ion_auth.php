 ...
 */
$config['site_title']                 = "edvsul.stud.if.ktu.lt";       // Site Title, example.com
$config['admin_email']                = "sedvis@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['mod_group']                  = 'mod';               // Default moderators group, use name
